                    ...
                    {!showResult ? (
                        <>
                            ...
                            <div className="cards">
                                ...
                                <div className="card" onClick={() => onSent("Brief summary of this concept: urban planning")}>
                                    <p>Brief summary of this concept: urban planning</p>
                        ...
                        <div className="result">
                            ...
                            <img src={assets.gemini_icon} alt="gemini" />
                                {loading ? (
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: resultData }} /> //hiển thị html
                                )}
                            </div>
                        </div>
                    )}
